...
#spacex_data ="https://cf-courses-data.s3.us.cloud-object-storage.appdomain.cloud/IBM-DS0321EN-SkillsNetwork/datasets/spacex_launch_dash.csv"
#spacex_data = "C:\Users\j-p\Documents\Capstone\Spacex_Dash.csv"   
print(spacex_df.columns)
print(' ')
print(spacex_df.head())
spacex_df = pd.read_csv(r"C:\Users\j-p\Documents\Capstone\Spacex_Dash.csv", sep=';')
